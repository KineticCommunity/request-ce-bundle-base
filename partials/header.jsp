    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a id="drop1" data-toggle="dropdown"><i class="fa fa-user fa-fw"></i> ${text.escape(identity.username)} <span class="fa fa-caret-down fa-fw"></span></a>
                ...
                <li>
                    <a id="drop2" data-toggle="dropdown"><span class="hidden-lg hidden-md">Kapps <span class="fa fa-caret-down fa-fw"></span></span><span class="hidden-sm hidden-xs fa fa-th fa-fw"></span></a>
